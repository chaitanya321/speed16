1. https://icofont.com/icons

2. https://remixicon.com/

3. icofont-architecture-alt

4. ri-vip-crown-2-line

5. ri-increase-decrease-fill

6. target="_blank"

7. Remove free folder after 31st Jan 2021

8. in the header section of all pages except home: remove header-transparent
...
Version: 2.1.0
  - Updated the hero waves effect to use native CSS animations instead of third party libraries
